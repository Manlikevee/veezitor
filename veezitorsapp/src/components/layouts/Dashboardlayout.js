...
const Dashboardlayout = ({children}) => {
  ...
  const {companySetup, fetchvisitors, setVisitationdata,  signout, logo, acceptvisitor, loadingaccept,    axiosInstance,  loading, error, fetchCompanySetup, visitationdata, sideloading, refreshAccessToken, checkusername, isSidebarOpen, isOverlayOpen, toggleSidebar, setIsOverlayOpen, setIsSidebarOpen, isvisitorbaropen, setisVistorbaropen, togglevisitorbar } = useContext(VeeContext);
