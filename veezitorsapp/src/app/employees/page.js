...
const page = () => {
  ...
  const { isOpen, test, setTest, username, myqrcode , loadingmyqrcode, employee, employeedataloaded, axiosInstance, fetchEmployeeData } = useContext(VeeContext);
  ...
  <div className="mytable">
    <div className="ttable visit mdt">
      <div className="tablerow">
        ...
        <div className="acc initialize">Staff_Id </div>
      ...
      {employeedataloaded ? <Employeetable mydata={employee} /> : 'loadingggggggggg'}
