...
// function addRandomIds(products) {
//   // Function to generate a random ID
//   function generateRandomId() {
//     return Math.floor(Math.random() * 583754784378000); // Change 1000 to whatever range you prefer
//   }

//   // Create a new array with random IDs
//   const newArrayWithIds = products.map(product => {
//     return { id: generateRandomId(), ...product };
//   });
...
//   const newArray = addRandomIds(products);
